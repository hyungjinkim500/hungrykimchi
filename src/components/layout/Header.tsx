...
const COUNTRY_EMERGENCY: Record<string, { ambulance: string; police: string; touristPolice?: string; embassy?: string }> = {
  ...
  // 유럽
  uk:          { ambulance: '999', police: '999', embassy: '+44-78-7650-6895' },
  france:      { ambulance: '15', police: '17', touristPolice: '3117', embassy: '+33-6-8028-5396' },
  germany:     { ambulance: '112', police: '110', embassy: '+49-173-407-6943' },
  italy:       { ambulance: '118', police: '113', embassy: '+39-335-1850499' },
  spain:       { ambulance: '112', police: '112', embassy: '+34-648-924-695' },
  portugal:    { ambulance: '112', police: '112', embassy: '+351-91-079-5055' },
  netherlands: { ambulance: '112', police: '112', embassy: '+31-64-264-8412' },
  switzerland: { ambulance: '144', police: '117', embassy: '+41-79-897-4086' },
  austria:     { ambulance: '144', police: '133', embassy: '+43-664-527-0743' },
  belgium:     { ambulance: '112', police: '101', embassy: '+32-476-45-7506' },
  sweden:      { ambulance: '112', police: '112', embassy: '+46-73-564-1648' },
  norway:      { ambulance: '113', police: '112', embassy: '+47-90-26-3544' },
  denmark:     { ambulance: '112', police: '114', embassy: '+45-25-21-7461' },
  finland:     { ambulance: '112', police: '112', embassy: '+358-40-903-1021' },
  poland:      { ambulance: '112', police: '112', embassy: '+48-887-46-0600' },
  czechia:     { ambulance: '155', police: '158', embassy: '+420-725-352-420' },
  hungary:     { ambulance: '104', police: '107', embassy: '+36-30-550-9922' },
  greece:      { ambulance: '166', police: '100', touristPolice: '1571', embassy: '+30-694-611-7098' },
  croatia:     { ambulance: '194', police: '192', embassy: '+385-91-2200-325' },
  romania:     { ambulance: '112', police: '112', embassy: '+40-741-185-558' },
  turkey:      { ambulance: '112', police: '155', embassy: '+90-533-203-6535' },
  russia:      { ambulance: '103', police: '102', embassy: '+7-495-783-2727' },
  ukraine:     { ambulance: '103', police: '102', embassy: '+380-95-119-0404' },
  // 아메리카
  usa:         { ambulance: '911', police: '911', embassy: '+1-202-939-5653' },
  canada:      { ambulance: '911', police: '911', embassy: '+1-613-986-0482' },
  mexico:      { ambulance: '911', police: '911', embassy: '+52-55-8581-2808' },
  brazil:      { ambulance: '192', police: '190' },
  argentina:   { ambulance: '107', police: '101' },
  peru:        { ambulance: '117', police: '105' },
  chile:       { ambulance: '131', police: '133' },
  colombia:    { ambulance: '132', police: '123' },
  cuba:        { ambulance: '104', police: '106' },
  guatemala:   { ambulance: '122', police: '110' },
  // 중동
  uae:         { ambulance: '998', police: '999', embassy: '+971-50-133-7362' },
  israel:      { ambulance: '101', police: '100', embassy: '+972-50-528-8345' },
  jordan:      { ambulance: '911', police: '911', embassy: '+962-79-750-0358' },
  egypt:       { ambulance: '123', police: '122', embassy: '+20-12-8333-3236' },
  qatar:       { ambulance: '999', police: '999', embassy: '+974-5001-1695' },
  saudiarabia: { ambulance: '911', police: '911', embassy: '+966-50-080-1065' },
  // 아프리카
  southafrica: { ambulance: '10177', police: '10111', embassy: '+27-66-332-5897' },
  kenya:       { ambulance: '999', police: '999', embassy: '+254-708-984-891' },
  ethiopia:    { ambulance: '907', police: '991', embassy: '+251-90-766-0404' },
  tanzania:    { ambulance: '112', police: '112' },
  ghana:       { ambulance: '193', police: '191', embassy: '+233-244-321-858' },
  nigeria:     { ambulance: '112', police: '112', embassy: '+234-90-8650-2916' },
  morocco:     { ambulance: '15', police: '19' },
  madagascar:  { ambulance: '117', police: '117' },
  // 오세아니아
  australia:   { ambulance: '000', police: '000', embassy: '+61-408-815-922' },
  newzealand:  { ambulance: '111', police: '111', embassy: '+64-21-0269-3271' },
  fiji:        { ambulance: '911', police: '917' },
  guam:        { ambulance: '911', police: '911' },
  saipan:      { ambulance: '911', police: '911' },
};
...
const CONTINENTS = [
  {
    ...
    countries: [
      { key: 'vietnam', label: '🇻🇳 베트남', cities: [
        ...
        { key: 'haiphong', label: '하이퐁', active: true },
        { key: 'bacninh', label: '박닌', active: true },
