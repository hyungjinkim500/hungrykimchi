...
const ZONES = [
  ...
  { name: 'CBP-비즈니스파크',  lat: 18.7980, lng: 99.0240 },
];
...
const KEYWORDS = [
  ...
  '한국 슈퍼마켓 치앙마이',
  '한국식품 치앙마이',
  'Korean grocery chiang mai',
  'Korean mart chiang mai',
  'Korean food store chiang mai',
  'Korean supermarket chiang mai',
  '한국 식재료 치앙마이',
  '코리안 마트 치앙마이',
  'K-mart chiang mai',
  'ร้านขายของเกาหลี เชียงใหม่',
  'ร้านอาหารเกาหลี ของชำ เชียงใหม่',
  'สินค้าเกาหลี เชียงใหม่',
  '한국 편의점 치앙마이',
  'Korean snack store chiang mai',
  '한국 라면 치앙마이',
  '한국 소주 치앙마이',
  'Korean drinks chiang mai',
  'Korean import store chiang mai',
  'Korean products chiang mai',
  'Korean convenience store chiang mai',
  '한국상회 치앙마이',
  '한국상점 치앙마이',
  'OWhale chiang mai',
];
