...
const KEYWORDS = [
  'công an Bắc Ninh',
  'police station Bac Ninh',
  'cảnh sát Bắc Ninh',
  'công an phường Bắc Ninh',
  'Korean consulate Bac Ninh',
  'lãnh sự Hàn Quốc Bắc Ninh',
  'xuất nhập cảnh Bắc Ninh',
  'immigration Bac Ninh',
  'cảnh sát phòng cháy Bắc Ninh',
  'fire station Bac Ninh',
  'công an huyện Yên Phong',
  'công an huyện Từ Sơn',
