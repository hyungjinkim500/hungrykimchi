...
const ZONES = [
  ...
  { name: '뉴마켓-에프섬',        lat: -36.8710, lng: 174.7760 },
...
const KEYWORDS = [
  ...
  'korean doctor',
  'korean clinic',
  'korean speaking doctor',
  'korean speaking dentist',
  'korean speaking GP',
  'korean GP',
  'korean medical',
  'korean dentist',
